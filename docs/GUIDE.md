...
- Update selection is by physical app bundle. ChatGPT's own updater remains active. Intel updates appear when OpenAI's feed offers a compatible build; otherwise use ChatGPT's update menu.
